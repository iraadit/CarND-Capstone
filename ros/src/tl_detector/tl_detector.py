...
class TLDetector(object):
    def __init__(self):
        ...
        self.light_classifier = TLClassifier(self.config['is_site']) #Use is_site flag from config to load the right model
        ...
        # Put Subscribers at the end, to have initialized everything before possible callback
    ...
    def process_traffic_lights(self):
        ...
        if(self.pose):
            ...
            car_wp_index = self.get_closest_waypoint([x, y])
